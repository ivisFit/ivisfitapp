...
export const Transformaciones2 = () => {
  return (
    <Box sx={{padding:"40px 0" , width:"100%", backgroundColor:"#090708", display:{xs:"none", smmid:"flex", lg:"none"}, justifyContent:"center", flexDirection:"column", alignItems:"center" }}>
        <Box sx={{display:"flex", justifyContent:"center", flexDirection:"column", alignItems:"center"}}>
            <h3 style={{color: "#e1aa43", letterSpacing:"0.3rem", fontFamily:"Source Sans Pro"}}>EDUCA TU MENTE. CAMBIA TU CUERPO</h3>
            <h2 style={{color: "#ffffff", letterSpacing:"0.1rem", fontWeight:"lighter", fontSize:"3rem"}}>Transformaciones de Alumnos</h2>
        </Box>

        <Box sx={{display:"flex", justifyContent:"center", alignItems:"center", flexDirection:"column", gap:"1.5vw", width:"100%", height:"90%"}}>

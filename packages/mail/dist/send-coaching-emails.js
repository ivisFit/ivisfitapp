...
export async function sendRutinaAsignadaEmail({ to, alumnaNombre, planNombre, appName, appUrl, }) {
    const link = appUrl
...
export async function sendRecordatorioEntrenamientoEmail({ to, alumnaNombre, hora, appName, appUrl, }) {
    const link = appUrl
...
export async function sendResumenSemanalEmail({ to, alumnaNombre, entrenosCompletados, checkinsCumplidos, checkinsParciales, checkinsNoPude, racha, appName, appUrl, }) {
    const link = appUrl
...
//# sourceMappingURL=send-coaching-emails.js.map